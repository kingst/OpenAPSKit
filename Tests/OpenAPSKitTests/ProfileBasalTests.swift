...
@Suite("Basal Tests")
struct BasalTests {
    @Test("should find current basal rate in a sample profile")
    ...
    @Test("should find current basal rate for midnight in a sample profile")
    ...
    @Test("should find current basal rate for 3am in a sample profile")
    ...
    @Test("should return nil with an empty profile")
    func handleEmptyProfile() async throws {
    ...
    @Test("should return nil for maxDailyBasal with empty profile")
    func handleEmptyProfileForMaxDaily() async throws {
